...
<div class="sidebar">
    <div>
        ...
        <ul class="menu-list">
            ...
            <c:set var="statusParam" value="${param.status}" />
            ...
            <li class="menu-item ${(uri == '/barista/orders' && (statusParam == null || statusParam == 'ALL')) ? 'active' : ''}">
            ...
            <li class="menu-item ${(uri == '/barista/orders' && statusParam == 'PENDING') ? 'active' : ''}">
            ...
            <li class="menu-item ${(uri == '/barista/orders' && statusParam == 'MAKING') ? 'active' : ''}">
            ...
            <li class="menu-item ${(uri == '/barista/orders' && statusParam == 'COMPLETED') ? 'active' : ''}">
