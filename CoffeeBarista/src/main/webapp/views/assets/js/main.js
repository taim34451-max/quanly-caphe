	        ...
	        <li class="order-item-row">
	            <div>
					...
					function initBrewCountdown() {
					    ...
					    const createdAt = parseInt(countdownEl.getAttribute('data-created-at'));
					    if (!createdAt) return;
					    // Standard brewing threshold: 10 minutes (600,000 ms)
					    ...
					    function updateTimer() {
					        ...
					        if (diff <= 0) {
					            ...
					            // Append visual alert if not already present
					            ...
					            // If less than 2 minutes remain, add visual yellow warning
					            if (diff < 2 * 60 * 1000) {
								    ...
								    const intervalId = setInterval(() => {
								        // If element is removed from DOM (navigated away), clear interval
