...
<body>
    ...
    <header class="main-header">
        <div class="header-container">
            ...
            <nav>
                ...
                <a href="thuc-don.jsp" class="active">Thực đơn</a>
    ...
    <section class="section">
        ...
        <div class="products">
            ...
            <div class="item ca-phe"><a href="chi-tiet-san-pham.jsp?id=1" class="product-link"><img src="hinh-anh/imgs/PHINDI_HANH_NHAN.jpg" alt="Phindi Hạnh Nhân"><p>Phindi Hạnh Nhân</p><span class="new">49.000đ</span></a></div>
