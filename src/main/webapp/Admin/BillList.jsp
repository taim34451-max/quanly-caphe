...
<div class="container" style="margin-top: 50px">
    ...
    <c:choose>
        ...
        <c:when test="${not empty BillList}">
            ...
            <c:forEach var="u" items="${BillList}">
...
const socket = new WebSocket(
	...
	socket.onmessage = function(event) {
	    ...
	    console.log("Admin nhận:", event.data);

	    

	        console.log("Có đơn mới → reload Admin");
	    ...
	    if (event.data === "STATUS_CHANGED") {
	        ...
	        console.log("Trạng thái đơn thay đổi → reload Admin");
